    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(ellipseButton,&QPushButton::clicked,[=](){
        //Set current tool to rect
        canvas->setTool(PainterCanvas::Ellipse);
    ...
    connect(eraserButton,&QPushButton::clicked,[=](){
        //Set current tool to rect
        canvas->setTool(PainterCanvas::Eraser);
