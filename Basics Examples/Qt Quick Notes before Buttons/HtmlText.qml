...
Item {
    property string htmlvalue: "Color (American English), or colour (Commonwealth English), is the characteristic of visual perception described through color categories, with names such as red, orange, yellow, green, blue, or purple. This perception of color derives from the stimulation of photoreceptor cells (in particular cone cells in the human eye and other vertebrate eyes) by electromagnetic radiation (in the visible spectrum in the case of humans). Color categories and physical specifications of color are associated with objects through the wavelengths of the light that is reflected from them and their intensities. This reflection is governed by the object's physical properties such as light absorption, emission spectra, etc.\
\
...
4.1	Additive coloring\
4.2	Subtractive coloring\
4.3	Structural color\
5	Additional terms\
6	See also\
7	References\
...
Color	{\displaystyle \lambda \,\!}\lambda \,\!\
(nm)	{\displaystyle \nu \,\!}\nu \,\!\
(THz)	{\displaystyle \nu _{b}\,\!}\nu_b \,\!\
(μm−1)	{\displaystyle E\,\!}E \,\!\
(eV)	{\displaystyle E\,\!}E \,\!\
(kJ mol−1)\
...
References\
 Wyszecki, Günther; Stiles, W.S. (1982). Colour Science: Concepts and Methods, Quantitative Data and Formulae (2nd ed.). New York: Wiley Series in Pure and Applied Optics. ISBN 978-0-471-02106-3.\
 ...
 Cronin TW, Marshall NJ (1989). \"A retina with at least ten spectral types of photoreceptors in a mantis shrimp\". Nature. 339 (6220): 137–40. Bibcode:1989Natur.339..137C. doi:10.1038/339137a0.\
 Craig F. Bohren (2006). Fundamentals of Atmospheric Radiation: An Introduction with 400 Problems. Wiley-VCH. p. 214. Bibcode:2006fari.book.....B. ISBN 978-3-527-40503-9.\
 Berlin, B. and Kay, P., Basic Color Terms: Their Universality and Evolution, Berkeley: University of California Press, 1969.\
 Waldman, Gary (2002). Introduction to light : the physics of light, vision, and color. Mineola: Dover Publications. p. 193. ISBN 978-0-486-42118-6.\
 ...
 Jameson, K.A.; Highnote, S.M.; Wasserman, L.M. (2001). \"Richer color experience in observers with multiple photopigment opsin genes\" (PDF). Psychonomic Bulletin and Review. 8 (2): 244–61. doi:10.3758/BF03196159. PMID 11495112.\
 ...
 Gary Westfahl (2005). The Greenwood Encyclopedia of Science Fiction and Fantasy: Themes, Works, and Wonders. Greenwood Publishing Group. pp. 142–143. ISBN 978-0-313-32951-7.\
 \"Chart: Color Meanings by Culture\". Archived from the original on 2010-10-12. Retrieved 2010-06-29.\
 Gnambs, Timo; Appel, Markus; Batinic, Bernad (2010). \"Color red in web-based knowledge testing\". Computers in Human Behavior. 26 (6): 1625–31. doi:10.1016/j.chb.2010.06.010.\
 ...
 CIE Pub. 17-4, International Lighting Vocabulary Archived 2010-02-27 at the Wayback Machine, 1987.\
 R.S. Berns, Principles of Color Technology Archived 2012-01-05 at the Wayback Machine, 3rd Ed., Wiley, New York (2001).\
...
The Effect of Color | OFF BOOK Documentary produced by Off Book\
Study of the history of colors\
The Color of Consciousness\
Colour (optics) at the Encyclopædia Britannica"
}
