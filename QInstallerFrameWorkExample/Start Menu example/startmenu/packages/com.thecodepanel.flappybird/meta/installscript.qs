...
Component.prototype.createOperations = function()
{
    ...
    {
        component.addOperation("CreateShortcut", "@TargetDir@/FlappyBird.exe", "@StartMenuDir@/FlappyBird.lnk",
            "workingDirectory=@TargetDir@", "iconPath=@TargetDir@\\RedBird2.ico",
             "description=Run Flappy Bird Game");

           component.addOperation("CreateShortcut", "@TargetDir@/FlappyBird.exe", 
            "@DesktopDir@/FlappyBird.lnk",
           "workingDirectory=@TargetDir@", "iconPath=@TargetDir@/RedBird2.ico",
            "description=Run Flappy Bird Game");
    }
}
